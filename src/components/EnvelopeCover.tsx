...
export const EnvelopeCover: React.FC<EnvelopeCoverProps> = ({ guestName, theme, onOpen }) => {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 md:p-8 ${theme.bgMain} ${theme.textPrimary} overflow-hidden`}>
      ...
      >
        <div className="relative min-h-[180px] sm:min-h-[210px] overflow-hidden metro-panel p-5 sm:p-6 md:min-h-[620px] md:p-12">
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div>
              ...
              <h2 className="mt-3 sm:mt-5 max-w-lg font-serif-luxury text-2xl sm:text-3xl leading-[0.95] text-[#fff7e8] md:mt-10 md:text-5xl lg:text-7xl">
                You Are Invited
              </h2>
            </div>
        ...
        <div className="relative flex min-h-[360px] sm:min-h-[400px] flex-col justify-between p-5 sm:p-6 text-center md:min-h-[520px] md:p-12">
          ...
          <div className="relative z-10">
            ...
            <h1 className="mt-3 sm:mt-5 font-serif-luxury text-3xl sm:text-4xl font-semibold leading-tight text-[#1f4b3a] md:mt-8 md:text-5xl lg:text-7xl">
              {COUPLE_DATA.groom.nickname}
              <span className="block text-xl sm:text-2xl italic text-[#b95838] md:text-4xl lg:text-5xl">&</span>
              {COUPLE_DATA.bride.nickname}
            </h1>
            <p className="mt-3 sm:mt-5 font-serif-luxury text-base sm:text-xl italic text-[#6b3f22]">
          ...
          <div className="relative z-10 my-5 border-y border-[#7a4a28]/25 py-4 md:my-8 md:py-6">
            ...
            <h2 className="mt-2 font-serif-luxury text-xl sm:text-2xl font-bold text-[#b95838] md:text-3xl">
          ...
          <div className="relative z-10">
            <p className="mx-auto mb-4 sm:mb-5 max-w-sm text-xs sm:text-sm leading-relaxed text-[#4f5c52] md:mb-7">
            ...
            <motion.button
              ...
              className={`w-full py-3 px-5 sm:py-4 sm:px-6 rounded-none flex items-center justify-center gap-2 sm:gap-3 font-bold tracking-wide transition-all text-sm sm:text-base ${theme.btnPrimary} group`}
            >
