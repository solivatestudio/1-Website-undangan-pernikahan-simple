...
export const CoupleSection: React.FC<CoupleSectionProps> = ({ theme }) => {
  return (
    <section id="mempelai" className={`relative overflow-hidden px-4 py-24 ${theme.bgSecondary}`}>
      <div className="absolute inset-y-10 left-0 w-10 bg-[#1f4b3a]/10" />
      <div className="absolute inset-y-20 right-0 w-10 bg-[#b95838]/10" />
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-11 gap-8 items-center justify-center">
          ...
          <motion.div
            ...
            className={`city-frame lg:col-span-5 bg-[#f8efdf]/85 p-8 relative group flex flex-col items-center text-center`}
          >
            <div className="relative w-48 h-60 md:w-56 md:h-72 rounded-t-full overflow-hidden border-4 border-amber-500/30 shadow-lg mb-6 group-hover:scale-[1.03] transition-transform duration-500">
              <img
            ...
            <h3 className="font-serif-luxury text-4xl md:text-5xl text-[#1f4b3a] mb-1 font-semibold">
              {COUPLE_DATA.groom.nickname}
            </h3>
            <h4 className="font-serif-luxury font-bold text-xl md:text-2xl mb-3">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className={`city-frame lg:col-span-5 bg-[#275448] p-8 relative group flex flex-col items-center text-center text-[#fff7e8]`}
          >
            <div className="relative w-48 h-60 md:w-56 md:h-72 rounded-t-full overflow-hidden border-4 border-amber-500/30 shadow-lg mb-6 group-hover:scale-[1.03] transition-transform duration-500">
              <img
            ...
            <h3 className="font-serif-luxury text-4xl md:text-5xl text-[#e0b66f] mb-1 font-semibold">
